...
% Load in data
if ~exist("M1neuralDynamics",'var')
    load("C:\Users\khan332\Documents\GitHub\M1NeuralDynamics")
end
...
y_trial = reshape(latentDynamicsSequence,dim,150,[]);
...
figure;
scatter(downSampledLeverFull, residuals);
xlabel('Observed Lever Trace');
ylabel('Residuals');
title('Residuals vs Observed Lever Trace');
