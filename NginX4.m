...
nIterrate = 500;
plotFlag = 0;
[LFP.probe1.CooledPA,LFP.probe1.BaselinePA] =...
   getPAProbeCooling(LFP.probe1.genPhase,IntanBehaviour,z_score,nIterrate,plotFlag,parameters);
...
Spikes = layerspikeAnalysis(Spikes,IntanBehaviour);
%% Spike field coherence using GP
Spikes = GPSFAnalysis(Spikes,LFP.probe3.genPhase);
