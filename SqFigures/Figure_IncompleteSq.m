...
figure(1),clf
subplot(221),
Show_Spikes(DLS_hitSpkRaw{neuron}),xlim([0 5000])
subplot(222),
Show_Spikes(DLS_incompleteSpkRaw{neuron}),xlim([0 5000])
subplot(223),
fr = bin_and_smooth_spikes(DLS_hitSpkRaw{neuron},10,5);
timeSp = linspace(0,5000,size(fr,2));
plot(timeSp,mean(fr)),xlim([0 5000])
subplot(224),
fr = bin_and_smooth_spikes(DLS_incompleteSpkRaw{neuron},10,5);
plot(timeSp,mean(fr)),xlim([0 5000])
%%
neuron = 11; %6 7
figure(1),clf
subplot(221),
Show_Spikes(M1_hitSpkRaw{neuron}),xlim([0 5000])
subplot(222),
Show_Spikes(M1_incompleteSpkRaw{neuron}),xlim([0 5000])
subplot(223),
fr = bin_and_smooth_spikes(M1_hitSpkRaw{neuron},10,5);
timeSp = linspace(0,5000,size(fr,2));
plot(timeSp,mean(fr)),xlim([0 5000])
subplot(224),
fr = bin_and_smooth_spikes(M1_incompleteSpkRaw{neuron},10,5);
plot(timeSp,mean(fr)),xlim([0 5000])
%%
