function [Behaviour] = readLeverBiPOLES(enpath,enfile,parameters,lfpTime,plotOption)
...
if cue==1 
    ...
    if parameters.BiPOLES == 1
        Behaviour.nCue = B(end,5)+B(end,6);
    end
...
if cue == 1
    ...
    if parameters.BiPOLES == 1
        cueIndex = find( Behaviour.B(:,end) == 1 | Behaviour.B(:,end) == 5 );
    end
