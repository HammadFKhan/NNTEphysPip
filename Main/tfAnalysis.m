...
theta = phi(5,:);
itpc = abs(mean(exp(1i*theta)));
polarplot([zeros(1,328); theta],[zeros(1,328); ones(1,328)],'k');
polarhistogram(theta,20);
title(['ITPC: ' num2str(itpc)]);



% Plot
figure,
subplot(4,1,1),stack_plot(LFP.lowpassData(12:15,1:100000)); title('LFP Band')
subplot(4,1,2),stack_plot(LFP.commonModeAvg(12,1:100000));title('Spike Band')
