...
ranksum(Stats.Hit.FFdrop,Stats.FakHit.FFdrop)
ranksum(Stats.Miss.FFdrop,Stats.FakMiss.FFdrop)
ranksum(Stats.FA.FFdrop,Stats.FakFA.FFdrop)

ranksum(Stats.Hit.FFdrop,Stats.Miss.FFdrop)
ranksum(Stats.Miss.FFdrop,Stats.FA.FFdrop)
ranksum(Stats.FA.FFdrop,Stats.Hit.FFdrop)
%% Plot Fak
