...
if isfield(TimeFreq.tf,'depth')
    ...
    figure,imagesc(-1000:1000,tf.beta.f,interp2(median(tf.depth.L23.beta.C,3),interpLevel))...
        ,caxis([0 .5]),title('\beta-L2/3 Spike Coupling'),colormap(jet),axis xy,set(gcf, 'Position',  [100, 100, 500, 500])
    figure,imagesc(-1000:1000,tf.gamma.f,interp2(median(tf.depth.L23.gamma.C,3),interpLevel))...
    ...
    keep(:,t) = [];
    figure,imagesc(-1000:1000,tf.theta.f,interp2(median(tf.depth.L4.theta.C,3),interpLevel))...
        ,caxis([0 .5]),title('\theta-L4 Spike Coupling'),colormap(jet),axis xy,set(gcf, 'Position',  [100, 100, 500, 500])
    figure,imagesc(-1000:1000,tf.beta.f,interp2(median(tf.depth.L4.beta.C,3),interpLevel))...
        ,caxis([0 .5]),title('\beta-L4 Spike Coupling'),colormap(jet),axis xy,set(gcf, 'Position',  [100, 100, 500, 500])
    figure,imagesc(-1000:1000,tf.gamma.f,interp2(median(tf.depth.L4.gamma.C,3),interpLevel))...
