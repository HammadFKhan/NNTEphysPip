...
%     [M2rh,M2rm,M2rmh,M2rmf] = makeSpikeCCA(M2Spikes);
    ...
    nModes = 5;
    iter = 5; %Number of training rounds
    dataKeep = 0.9; % Percentage we keep for CCA model

    timeLag = NaN;
    shufFlag = 0;
    IntanBehaviour.parameters.cool = 1;
    ...
    if IntanBehaviour.parameters.cool
        ...
        CCAResults(fileNum).CCA = getCCA(M1rh,M1rm,M1rmh,M1rmf,M2rh,M2rm,M2rmh,M2rmf,iter,nModes,dataKeep,timeLag,shufFlag);
    end
end
%%
